...
class Instance(Base):
    ...
    balance_alert_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    balance_alert_threshold: Mapped[float | None] = mapped_column(Float, nullable=True)
